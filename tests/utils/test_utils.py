...
analysis_results_protype = {
    ...
    "rephrase": False,
    "wikipedia": {
        "extract": "OpenClassrooms est un site web de formation en "
...
analysis_results_case2 = {"greetings": False, "rephrase": True}
