    ...
    "results": [
        {
            "address_components": [
                ...
                {"long_name": "76490", "short_name": "76490", "types": ["postal_code"]},
            ],
            "formatted_address": "Pont de Brotonne, 76490 Rives-en-Seine, France",
            "geometry": {
                "location": {"lat": 49.5205268, "lng": 0.7472835},
                "location_type": "GEOMETRIC_CENTER",
                "viewport": {
                    "northeast": {"lat": 49.5218757802915, "lng": 0.7486324802915021},
                    "southwest": {"lat": 49.5191778197085, "lng": 0.745934519708498},
                },
            },
...
@pytest.mark.xfail(
    reason="Test failing for formatting reasons but content is " "as expected."
)
def test_call_api_():
    """Should return a response object with status 200."""

    custom_params = {"address": "pont de brotonne", "key": Gmaps.GMAPS_KEY}
...
def test_extract_result(mock_response):
    ...
    expected_result = {
        "address": "Pont de Brotonne, 76490 Rives-en-Seine, " "France",
